var app = (function () {
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 47, 8, 915);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			add_location(div, file$1, 45, 4, 875);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(45:2) {#each grid as row, i}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 43, 2, 826);
    			add_location(div1, file$1, 41, 0, 785);
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*grid*/ 1) set_data_dev(t1, /*grid*/ ctx[0]);
    ...
    const chars = {
      ...
      a: [0x00, 0x00, 0x1e, 0x30, S, 0x33, 0x6e, 0x00],
    ...
    function create_fragment$3(ctx) {
    	...
    	grid_1.$on("boxclick", /*handleCheckBoxClick*/ ctx[4]);
    	button = new Button({ $$inline: true });
    	button.$on("click", /*handleResetClick*/ ctx[5]);

    	bytearray = new ByteArray({
    			props: { byteArray: /*byteArray*/ ctx[2] },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 73, 1, 1951);
    			attr_dev(main, "class", "svelte-1na4wt1");
    			add_location(main, file$3, 72, 0, 1943);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*key*/ 2) set_data_dev(t2, /*key*/ ctx[1]);
    			const grid_1_changes = {};
    			if (dirty & /*grid*/ 1) grid_1_changes.grid = /*grid*/ ctx[0];
    			grid_1.$set(grid_1_changes);
    			if (!current || dirty & /*grid*/ 1) set_data_dev(t7, /*grid*/ ctx[0]);
    			const bytearray_changes = {};
    			if (dirty & /*byteArray*/ 4) bytearray_changes.byteArray = /*byteArray*/ ctx[2];
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('keyCode' in $$props) $$invalidate(3, keyCode = $$props.keyCode);
    		if ('grid' in $$props) $$invalidate(0, grid = $$props.grid);
    		if ('byteArray' in $$props) $$invalidate(2, byteArray = $$props.byteArray);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*grid*/ 1) {
    			 $$invalidate(2, byteArray = grid.map(item => {
